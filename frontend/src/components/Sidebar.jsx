  ...
  const menuItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Directorio Maestro', path: '/maestro-leads', roles: ['super_admin', 'admin_empresa', 'supervisor', 'agente', 'agente_cotizador', 'riesgos'], icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /> },
        { name: 'Cotizador', path: '/cotizador', roles: ['super_admin', 'admin_empresa', 'supervisor', 'agente', 'agente_cotizador', 'riesgos'], icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" /> },
