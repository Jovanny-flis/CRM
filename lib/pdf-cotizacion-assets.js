...
/** Imágenes de marca para el PDF de cotización (versionadas en git):
 *  assets/branding/flising-logo-blanco.png
 *  assets/cotizacion-activos/{sedan|suv|camionetas|lujo|tractocamion|autobus|otro}_blanco.png
 */
